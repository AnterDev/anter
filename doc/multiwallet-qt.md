...
In order to support loading of multiple wallets in anter-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is anter.cpp.
...
Changes to anter.cpp
----------------------
anter.cpp is the entry point into anter-qt, and as such, will require some minor modifications to provide hooks for
