...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* anter features */
        {"anter", "masternode", &masternode, true, true, false},
        {"anter", "listmasternodes", &listmasternodes, true, true, false},
        {"anter", "getmasternodecount", &getmasternodecount, true, true, false},
        {"anter", "masternodeconnect", &masternodeconnect, true, true, false},
        {"anter", "masternodecurrent", &masternodecurrent, true, true, false},
        {"anter", "masternodedebug", &masternodedebug, true, true, false},
        {"anter", "startmasternode", &startmasternode, true, true, false},
        {"anter", "createmasternodekey", &createmasternodekey, true, true, false},
        {"anter", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"anter", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"anter", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"anter", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"anter", "getmasternodescores", &getmasternodescores, true, true, false},
        {"anter", "mnbudget", &mnbudget, true, true, false},
        {"anter", "preparebudget", &preparebudget, true, true, false},
        {"anter", "submitbudget", &submitbudget, true, true, false},
        {"anter", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"anter", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"anter", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"anter", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"anter", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"anter", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"anter", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"anter", "checkbudgets", &checkbudgets, true, true, false},
        {"anter", "mnsync", &mnsync, true, true, false},
        {"anter", "spork", &spork, true, true, false},
        {"anter", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"anter", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use anterd, or the -server option to anter-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> anter-cli " + methodname + " " + args + "\n";
}
