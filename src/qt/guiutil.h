...
/** Utility functions used by the anter Qt UI.
 */
namespace GUIUtil
{
...
// Render anter addresses in monospace font
...
// Parse "anter:" URI into recipient object, return true on successful parsing
