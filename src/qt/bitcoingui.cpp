...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a anter address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and anter: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About anter"), this);
    aboutAction->setStatusTip(tr("Show information about anter"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for anter"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your anter addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified anter addresses"));
    ...
    openAction->setStatusTip(tr("Open a anter: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the anter help message to get a list with possible anter command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("anter client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to anter network", "", count));
}
...
{
    QString strTitle = tr("anter"); // default title
