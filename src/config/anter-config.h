/* src/config/anter-config.h.  Generated from anter-config.h.in by configure.  */
/* src/config/anter-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef anter_CONFIG_H

#define anter_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.anter.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "anter Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "anter Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "anter"
