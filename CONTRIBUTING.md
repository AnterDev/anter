Contributing to anter
============================

The anter project operates an open contributor model where anyone is
...
The following applies to code changes to the anter project, and is not to be
confused with overall anter Network Protocol consensus changes.

Whether a pull request is merged into anter rests with the project merge
...
Patches that change anter consensus rules are considerably more involved than
...
Where a patch set proposes to change the anter consensus, it must have been
...
The project leader is the release manager for each anter release.
