...
This means one can have an always-on anterd instance running, and another local anterd/anter-qt instance which connects to this node and receives blocks from it.
