...
RESOURCES += src/qt/anter.qrc src/qt/anter_locale.qrc

TRANSLATIONS += src/qt/locale/anter_bg.ts \
                src/qt/locale/anter_de.ts \
                src/qt/locale/anter_en.ts \
                src/qt/locale/anter_es.ts \
                src/qt/locale/anter_fi.ts \
                src/qt/locale/anter_fr.ts \
                src/qt/locale/anter_it.ts \
                src/qt/locale/anter_ja.ts \
                src/qt/locale/anter_pl.ts \
                src/qt/locale/anter_pt.ts \
                src/qt/locale/anter_ru.ts \
                src/qt/locale/anter_sk.ts \
                src/qt/locale/anter_sv.ts \
                src/qt/locale/anter_vi.ts \
                src/qt/locale/anter_zh_CN.ts \
                src/qt/locale/anter_zh_TW.ts
